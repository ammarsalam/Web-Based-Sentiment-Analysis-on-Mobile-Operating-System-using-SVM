...
import wordcloud from '../../assets/neutral_android_wordcloud1.png';

const AndroidWordCloudNeutral = () => {
  const handleDownload = () => {
    const link = document.createElement("a");
    link.href = wordcloud;
    link.download = "android_neutral_wordcloud.png";
  ...
  return (
    ...
    >
      <h2 className='text-xl font-medium mb-4 text-gray-100'>Neutral Word Cloud In Android</h2>
...
export default AndroidWordCloudNeutral