...
const AndroidCommmentByTopic = () => {
  const [chartData, setChartData] = useState([]);

  useEffect(() => {
    // Fetch data from /comments_by_platform endpoint for Android platform
    axios.get("http://localhost:5000/topic_by_platform?platform=Android")
      .then((res) => {
  ...
  return (
    ...
    >
      <h2 className='text-xl font-semibold text-gray-100 mb-4'>Sentiment Distribution by Topic for Android</h2>
...
export default AndroidCommmentByTopic;
