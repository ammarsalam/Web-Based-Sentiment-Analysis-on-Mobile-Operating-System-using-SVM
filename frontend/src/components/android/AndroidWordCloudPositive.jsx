...
import wordcloud from '../../assets/positive_android_wordcloud2.png';

const AndroidWordCloudPositive = () => {
  const handleDownload = () => {
    const link = document.createElement("a");
    link.href = wordcloud;
    link.download = "android_positive_wordcloud.png";
  ...
  return (
    ...
    >
      <h2 className='text-xl font-medium mb-4 text-gray-100'>Positive Word Cloud In Android</h2>
...
export default AndroidWordCloudPositive;
