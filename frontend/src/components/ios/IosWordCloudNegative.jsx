...
import wordcloud from '../../assets/negative_ios_wordcloud2.png';

const IosWordCloudNegative = () => {
  const handleDownload = () => {
    const link = document.createElement("a");
    link.href = wordcloud;
    link.download = "ios_negative_wordcloud.png";
  ...
  return (
    ...
    >
      <h2 className='text-xl font-medium mb-4 text-gray-100'>Negative Word Cloud In IOS</h2>
...
export default IosWordCloudNegative