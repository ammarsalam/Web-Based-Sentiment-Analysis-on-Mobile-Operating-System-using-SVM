...
import wordcloud from '../../assets/positive_ios_wordcloud2.png';

const IosWordCloudPositive = () => {
  const handleDownload = () => {
    const link = document.createElement("a");
    link.href = wordcloud;
    link.download = "ios_positive_wordcloud.png";
  ...
  return (
    ...
    >
      <h2 className='text-xl font-medium mb-4 text-gray-100'>Positive Word Cloud In IOS</h2>
...
export default IosWordCloudPositive;
