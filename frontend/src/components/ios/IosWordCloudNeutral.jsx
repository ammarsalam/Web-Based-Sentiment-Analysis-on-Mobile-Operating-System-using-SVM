...
import wordcloud from '../../assets/neutral_ios_wordcloud1.png';

const IosWordCloudNeutral = () => {
  const handleDownload = () => {
    const link = document.createElement("a");
    link.href = wordcloud;
    link.download = "ios_neutral_wordcloud.png";
  ...
  return (
    ...
    >
      <h2 className='text-xl font-medium mb-4 text-gray-100'>Neutral Word Cloud In IOS</h2>
...
export default IosWordCloudNeutral