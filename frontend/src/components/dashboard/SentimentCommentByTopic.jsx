...
const SentimentCommmentByTopic = () => {
  const [chartData, setChartData] = useState([]);

  useEffect(() => {
    // Fetch data from /comments_by_topic endpoint
    axios.get("http://localhost:5000/commentsbytopic")
      .then((res) => {
  ...
  return (
    ...
    >
      <h2 className='text-xl font-semibold text-gray-100 mb-4'>Sentiment Distribution by Topic</h2>
...
export default SentimentCommmentByTopic;
