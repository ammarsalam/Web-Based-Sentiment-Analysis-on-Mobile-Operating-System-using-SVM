...
import wordcloud from '../../assets/neutral_harmonyos_wordcloud1.png';

const HarmonyosWordCloudNeutral = () => {
  const handleDownload = () => {
    const link = document.createElement("a");
    link.href = wordcloud;
    link.download = "harmonyos_neutral_wordcloud.png";
  ...
  return (
    ...
    >
      <h2 className='text-xl font-medium mb-4 text-gray-100'>Neutral Word Cloud In HarmonyOS</h2>
...
export default HarmonyosWordCloudNeutral