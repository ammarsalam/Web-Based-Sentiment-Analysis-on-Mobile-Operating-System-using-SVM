...
import wordcloud from '../../assets/negative_harmonyos_wordcloud2.png';

const HarmonyosWordCloudNegative = () => {
  const handleDownload = () => {
    const link = document.createElement("a");
    link.href = wordcloud;
    link.download = "harmonyos_negative_wordcloud.png";
  ...
  return (
    ...
    >
      <h2 className='text-xl font-medium mb-4 text-gray-100'>Negative Word Cloud In HarmonyOS</h2>
...
export default HarmonyosWordCloudNegative