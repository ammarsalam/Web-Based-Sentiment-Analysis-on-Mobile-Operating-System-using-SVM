...
import wordcloud from '../../assets/positive_harmonyos_wordcloud2.png';

const HarmonyosWordCloudPositive = () => {
  const handleDownload = () => {
    const link = document.createElement("a");
    link.href = wordcloud;
    link.download = "harmonyos_positive_wordcloud.png";
  ...
  return (
    ...
    >
      <h2 className='text-xl font-medium mb-4 text-gray-100'>Positive Word Cloud In HarmonyOS</h2>

      <div className="relative group flex justify-center">
        <img
          src={wordcloud}
          alt="HarmonyOS Word Cloud"
...
export default HarmonyosWordCloudPositive;
